    ...
    <div className="flex-1 bg-zinc-50 flex flex-col justify-between min-h-screen">
      ...
      <header className="border-b border-zinc-200/50 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5" onClick={() => window.location.href = "/"}>
            <img src="/logo.svg" alt="EduNexus" className="h-8 w-auto object-contain cursor-pointer" />
            <span className="font-semibold text-zinc-900 tracking-tight cursor-pointer"><span className="text-[#1572FE]">Edu</span>Nexus</span>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <div className="max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-800 text-xs font-medium">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-zinc-900 leading-tight">
            ...
            <span className="text-[#1572FE]">Luxury-minimalist workspace.</span>
          </h1>
          <p className="text-base md:text-lg text-zinc-500 font-light max-w-xl mx-auto leading-relaxed">
            A high-performance, multi-tenant workspace designed to eliminate cognitive load. Built securely for administrators, teachers, students, and parents.
          </p>
          <div className="pt-4 flex flex-col sm:flex-row justify-center gap-3">
            <Link href="/login">
              <Button size="lg" className="bg-[#1572FE] hover:bg-[#0f62d4] text-white font-semibold px-8 py-3 rounded-xl shadow-md flex items-center gap-2">
      ...
      <footer className="border-t border-zinc-200/50 bg-white py-6">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-400">
          <p>© 2026 EduNexus. Built for modern administrative efficiency.</p>
